...
BOOST_AUTO_TEST_CASE(GetBalance) {
	...
	double response;
	BOOST_REQUIRE_NO_THROW(response = fx.btc.getbalance());
	BOOST_REQUIRE_NO_THROW(response = fx.btc.getbalance(""));
...
BOOST_AUTO_TEST_CASE(GetReceivedByAccount) {
	...
	double response;
	BOOST_REQUIRE_NO_THROW(response = fx.btc.getreceivedbyaccount(""));
...
BOOST_AUTO_TEST_CASE(GetReceivedByAddress) {
	...
	BOOST_REQUIRE_NO_THROW(response = fx.btc.getreceivedbyaddress(param));
